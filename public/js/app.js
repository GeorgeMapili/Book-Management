...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  login: function login(params) {
    return _api__WEBPACK_IMPORTED_MODULE_0__["default"].post('/api/login_user', params);
  },
  getBook: function getBook() {
    return _api__WEBPACK_IMPORTED_MODULE_0__["default"].get('/api/v1/book');
  },
  createBook: function createBook(params) {
    return _api__WEBPACK_IMPORTED_MODULE_0__["default"].post('/api/v1/addbook', params);
  },
  logout: function logout() {
    return _api__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"]('/api/v1/logout');
  }
});
...
/* harmony import */ var _helpers_utilities__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./helpers/utilities */ "./resources/js/helpers/utilities.js");
...
vue__WEBPACK_IMPORTED_MODULE_6__["default"].use((vue_sweetalert2__WEBPACK_IMPORTED_MODULE_5___default()));

vue__WEBPACK_IMPORTED_MODULE_6__["default"].prototype.$utils = _helpers_utilities__WEBPACK_IMPORTED_MODULE_7__["default"];
vue__WEBPACK_IMPORTED_MODULE_6__["default"].use((vue_axios__WEBPACK_IMPORTED_MODULE_2___default()), (axios__WEBPACK_IMPORTED_MODULE_3___default()));
  ...
  swal: function swal(id) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        _this.axios["delete"]("api/v1/deletebook/".concat(id)).then(function (response) {
          if (response.status) {
          ...
          _this.$utils.showError('Error', error.response.data.errors);
...
/***/ "./resources/js/router/middleware/index.js":
/*!*************************************************!*\
  !*** ./resources/js/router/middleware/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _rules_guest__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rules/guest */ "./resources/js/router/middleware/rules/guest.js");
/* harmony import */ var _rules_user__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rules/user */ "./resources/js/router/middleware/rules/user.js");


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  guest: _rules_guest__WEBPACK_IMPORTED_MODULE_0__["default"],
  user: _rules_user__WEBPACK_IMPORTED_MODULE_1__["default"]
});

/***/ }),

/***/ "./resources/js/router/middleware/rules/guest.js":
/*!*******************************************************!*\
  !*** ./resources/js/router/middleware/rules/guest.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/router/middleware/rules/user.js":
/*!******************************************************!*\
  !*** ./resources/js/router/middleware/rules/user.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _middleware_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./middleware/index */ "./resources/js/router/middleware/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vue_router__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  routes: [{
    ...
    component: function component() {
      return __webpack_require__.e(/*! import() | Login */ "Login").then(__webpack_require__.bind(__webpack_require__, /*! ../views/auth/Login */ "./resources/js/views/auth/Login.vue"));
    },
    beforeEnter: _middleware_index__WEBPACK_IMPORTED_MODULE_0__["default"].guest
  }, {
    path: "/",
    component: function component() {
      return __webpack_require__.e(/*! import() | Login */ "Login").then(__webpack_require__.bind(__webpack_require__, /*! ../views/home/Home */ "./resources/js/views/home/Home.vue"));
    },
    beforeEnter: _middleware_index__WEBPACK_IMPORTED_MODULE_0__["default"].guest
  }, {
    path: "/register",
    name: "register",
    component: function component() {
      return __webpack_require__.e(/*! import() | Register */ "Register").then(__webpack_require__.bind(__webpack_require__, /*! ../views/auth/Register */ "./resources/js/views/auth/Register.vue"));
    },
    beforeEnter: _middleware_index__WEBPACK_IMPORTED_MODULE_0__["default"].guest
  }, {
    path: "/book",
    name: "book",
    component: function component() {
      return __webpack_require__.e(/*! import() | Book */ "Book").then(__webpack_require__.bind(__webpack_require__, /*! ../views/book/Book */ "./resources/js/views/book/Book.vue"));
    },
    beforeEnter: _middleware_index__WEBPACK_IMPORTED_MODULE_0__["default"].user
  }, {
    path: "/book/add-book",
    name: "addbook",
    component: function component() {
      return __webpack_require__.e(/*! import() | AddBook */ "AddBook").then(__webpack_require__.bind(__webpack_require__, /*! ../views/book/AddBook */ "./resources/js/views/book/AddBook.vue"));
    },
    beforeEnter: _middleware_index__WEBPACK_IMPORTED_MODULE_0__["default"].user
  }, {
    ...
    name: "editbook",
    component: function component() {
      return __webpack_require__.e(/*! import() | AddBook */ "AddBook").then(__webpack_require__.bind(__webpack_require__, /*! ../views/book/EditBook */ "./resources/js/views/book/EditBook.vue"));
    },
    beforeEnter: _middleware_index__WEBPACK_IMPORTED_MODULE_0__["default"].user
  }, {
    path: "*",
    name: "notFound",
    component: function component() {
      return __webpack_require__.e(/*! import() | NotFound */ "NotFound").then(__webpack_require__.bind(__webpack_require__, /*! ../views/auth/NotFound */ "./resources/js/views/auth/NotFound.vue"));
    },
    beforeEnter: _middleware_index__WEBPACK_IMPORTED_MODULE_0__["default"].guest
  }]
}));
    ...
    auth: {
      ...
      actions: {
        login: function login(_ref, user) {
          return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
            var commit, _yield$repository$log, data;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    commit = _ref.commit;
                    _context.next = 3;
                    return _api_repository__WEBPACK_IMPORTED_MODULE_1__["default"].createSession();

                  case 3:
                    _context.next = 5;
                    return _api_repository__WEBPACK_IMPORTED_MODULE_1__["default"].login(user);

                  case 5:
                    _yield$repository$log = _context.sent;
                    data = _yield$repository$log.data;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    commit = _ref2.commit;
                    _context2.next = 3;
                    return _api_repository__WEBPACK_IMPORTED_MODULE_1__["default"].logout();
        ...
        createBook: function createBook(_ref3, book) {
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    commit = _ref3.commit;
                    _context3.next = 3;
                    return _api_repository__WEBPACK_IMPORTED_MODULE_1__["default"].createBook(book);
        ...
        [
          ...
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("div", { staticClass: "d-flex navbar-nav" }, [
                !_vm.authenticated
                  ? _c(
                      "li",
...
/******/ 			if ({"Login":1,"Register":1,"AddBook":1,"NotFound":1}[chunkId]) return "js/" + chunkId + ".js";
/******/ 			if (chunkId === "Book") return "js/Book.js";
