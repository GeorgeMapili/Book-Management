            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div>
                        ...
                        <button type="submit" class="btn btn-primary" @click="updateBook">Update</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    mounted(){
        ...
        this.axios.get(`/api/v1/editbook/${id}`)
        .then((response) => {
    ...
    methods: {
        updateBook(){
            this.axios.post(`/api/v1/updatebook/${this.bookId}`, this.fields)
            .then((response) => {
